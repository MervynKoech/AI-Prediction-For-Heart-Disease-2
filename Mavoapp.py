...
# --- Page 2: Model Performance ---
    ...
    with col2:
        ...
        RocCurveDisplay.from_predictions(test_artifacts["y_test"], test_artifacts["y_prob_rf"], name="Random Forest", ax=ax_roc, color="blue")
        RocCurveDisplay.from_predictions(test_artifacts["y_test"], test_artifacts["y_prob_xgb"], name="XGBoost", ax=ax_roc, color="green")
